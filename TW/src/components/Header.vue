<template>
            ...
            <div class="flex">
                ...
                >
                    ...
                    >
                        ...
                        >
                            <img
                                src="../../public/images/icons/bed.svg"
                        ...
                        >
                            <img
                                src="../../public/images/icons/sofa.svg"
                                class="w-5 h-5 object-contain"
                            />
                        ...
                        >
                            <img
                                src="../../public/images/icons/office.svg"
                                class="w-5 h-5 object-contain"
                            />
                            <span class="ml-6 text-gray-600 text-sm"
                                >Office</span
                        ...
                        >
                            <img
                                src="../../public/images/icons/terrace.svg"
                                class="w-5 h-5 object-contain"
                            />
                            <span class="ml-6 text-gray-600 text-sm"
                                >Outdoor</span
                        ...
                        >
                            <img
                                src="../../public/images/icons/bed-2.svg"
                                class="w-5 h-5 object-contain"
                            />
                            <span class="ml-6 text-gray-600 text-sm"
                                >Mattress</span
                        ...
                        >
                            <img
                                src="../../public/images/icons/restaurant.svg"
                                class="w-5 h-5 object-contain"
                            />
                            <span class="ml-6 text-gray-600 text-sm">Sofa</span>
                        </a>
    ...
    <div
        ...
        style="background-image: url('../../public/images/banner-bg.jpg')"
    >
        <div class="container">
            <!-- banner content -->
            <h1
                class="xl:text-6xl md:text-5xl text-4xl text-gray-800 font-medium mb-4"
            >
    ...
    <div class="container pb-16">
        ...
        <div class="grid lg:grid-cols-4 sm:grid-cols-2 gap-6">
            ...
            <div class="group rounded bg-white shadow overflow-hidden">
                ...
                <div class="relative">
                    <img
                        src="../../public/images/products/product9.jpg"
                        class="w-full"
                    />
                    <div
            ...
            <div class="group rounded bg-white shadow overflow-hidden">
                ...
                <div class="relative">
                    <img
                        src="../../public/images/products/product8.jpg"
                        class="w-full"
                    />
                    <div
                        class="absolute inset-0 bg-black bg-opacity-40 flex items-center justify-center gap-2 opacity-0 group-hover:opacity-100 transition"
            ...
            <div class="group rounded bg-white shadow overflow-hidden">
                ...
                <div class="relative">
                    <img
                        src="../../public/images/products/product12.jpg"
                        class="w-full"
                    />
                    <div
                        class="absolute inset-0 bg-black bg-opacity-40 flex items-center justify-center gap-2 opacity-0 group-hover:opacity-100 transition"
    ...
    <div class="container pb-16">
        <a href="#">
            <img src="../../public/images/offer.jpg" class="w-full" />
        </a>
    </div>
    <!-- ad section end -->
    ...
    <div class="container pb-16">
        ...
        <div class="grid lg:grid-cols-4 sm:grid-cols-2 gap-6">
            ...
            <div class="group rounded bg-white shadow overflow-hidden">
                ...
                <div class="relative">
                    <img
                        src="../../public/images/products/product10.jpg"
                        class="w-full"
                    />
                    <div
                        class="absolute inset-0 bg-black bg-opacity-40 flex items-center justify-center gap-2 opacity-0 group-hover:opacity-100 transition"
            ...
            <div class="group rounded bg-white shadow overflow-hidden">
                ...
                <div class="relative">
                    <img
                        src="../../public/images/products/product11.jpg"
                        class="w-full"
                    />
                    <div
                        class="absolute inset-0 bg-black bg-opacity-40 flex items-center justify-center gap-2 opacity-0 group-hover:opacity-100 transition"
    ...
    <div class="bg-gray-800 py-4">
        <div class="container flex items-center justify-between">
            ...
            <div>
                <img src="../../public/images/methods.png" class="h-5" />
            </div>
        </div>
    </div>
</template>
